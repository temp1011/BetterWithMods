...
public final class ItemExt {
    ...
    public static void initBuoyancy() {
        ...
        buoyancy.put(ItemMaterial.getMaterial("hemp"), 1.0F);
        buoyancy.put("gearWood", 1.0F);
        buoyancy.put("foodFlour", 1.0F);
        buoyancy.put("string", 1.0F);
        buoyancy.put(ItemMaterial.getMaterial("scoured_leather"), 1.0F);
        buoyancy.put(BWMItems.DONUT, 1.0F);
        buoyancy.put(ItemMaterial.getMaterial("dung"), 1.0F);
        buoyancy.put(BWMItems.WINDMILL, 1.0F);
        buoyancy.put("fabricHemp", 1.0F);
        buoyancy.put(BWMItems.DONUT, 1.0F);
        buoyancy.put(BWMItems.DONUT, 1.0F);
        buoyancy.put(BWMBlocks.GRATE, 1.0F);
        buoyancy.put(ItemMaterial.getMaterial("tanned_leather"), 1.0F);
        buoyancy.put(ItemMaterial.getMaterial("leather_strap"), 1.0F);
        buoyancy.put(ItemMaterial.getMaterial("leather_belt"), 1.0F);
        buoyancy.put(ItemMaterial.getMaterial("wood_blade"), 1.0F);
        buoyancy.put(ItemMaterial.getMaterial("glue"), 0.0F);
        buoyancy.put(ItemMaterial.getMaterial("tallow"), 1.0F);
        buoyancy.put(ItemMaterial.getMaterial("haft"), 1.0F);
        buoyancy.put(BWMBlocks.URN, 1.0F);
        buoyancy.put(ItemMaterial.getMaterial("sawdust"), 1.0F);
        buoyancy.put(BWMItems.DYNAMITE, 1.0F);
        buoyancy.put(ItemMaterial.getMaterial("soul_dust"), 1.0F);
        buoyancy.put(ItemMaterial.getMaterial("nether_sludge"), 1.0F);
        buoyancy.put(Items.CARROT, 1.0F);
        buoyancy.put(BWMItems.CREEPER_OYSTER, 1.0F);
        buoyancy.put(ItemMaterial.getMaterial("leather_cut"), 1.0F);
        buoyancy.put(ItemMaterial.getMaterial("tanned_leather_cut"), 1.0F);
        buoyancy.put(ItemMaterial.getMaterial("scoured_leather_cut"), 1.0F);
        buoyancy.put("barkWood", 1.0F);
        buoyancy.put(Items.DYE, EnumDyeColor.BROWN.getDyeDamage(), 1.0F);
        buoyancy.put(ItemMaterial.getMaterial("soul_flux"), 1.0F);
