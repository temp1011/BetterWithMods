...
public class OutputRenderer implements IIngredientRenderer<IOutput> {
    ...
    @Override
    public void render(Minecraft minecraft, int xPosition, int yPosition, @Nullable IOutput ingredient) {
        if (ingredient != null) {
    ...
    @Override
    public List<String> getTooltip(Minecraft minecraft, IOutput ingredient, ITooltipFlag tooltipFlag) {
    ...
    @Override
    public FontRenderer getFontRenderer(Minecraft minecraft, IOutput ingredient) {
