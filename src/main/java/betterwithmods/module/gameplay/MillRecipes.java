...
public class MillRecipes extends Feature {
    ...
    public void init(FMLInitializationEvent event) {
        ...
        BWRegistry.MILLSTONE.addMillRecipe(new ItemStack(Items.BLAZE_ROD), Lists.newArrayList(new ItemStack(Items.BLAZE_POWDER, 3)), SoundEvents.ENTITY_GHAST_SCREAM);
