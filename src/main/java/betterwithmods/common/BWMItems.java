...
public final class BWMItems {
    ...
    public static final Item RAW_EGG = new ItemFood(2, 0.2f, false).setPotionEffect(new PotionEffect(MobEffects.HUNGER, 600, 0), 0.3F).setCreativeTab(BWCreativeTabs.BWTAB).setRegistryName("raw_egg");
    ...
    public static final Item RAW_SCRAMBLED_EGG = new ItemFood(2, 0.3f,false).setPotionEffect(new PotionEffect(MobEffects.HUNGER, 600, 0), 0.3F).setCreativeTab(BWCreativeTabs.BWTAB).setRegistryName("raw_scrambled_egg");
    public static final Item COOKED_SCRAMBLED_EGG = new ItemFood(3,0.5f, false).setCreativeTab(BWCreativeTabs.BWTAB).setRegistryName("cooked_scrambled_egg");
    ...
    public static final Item COOKED_OMELET = new ItemFood(4,1, false).setCreativeTab(BWCreativeTabs.BWTAB).setRegistryName("cooked_omelet");
    public static final Item HAM_AND_EGGS = new ItemFood(5,1, false).setCreativeTab(BWCreativeTabs.BWTAB).setRegistryName("ham_and_eggs");
    public static final Item TASTY_SANDWICH = new ItemFood(6, 0.7f, false).setCreativeTab(BWCreativeTabs.BWTAB).setRegistryName("tasty_sandwich");
    ...
    public static final Item BEEF_DINNER = new ItemFood(6, 0.6f, false).setCreativeTab(BWCreativeTabs.BWTAB).setRegistryName("beef_dinner");
    public static final Item BEEF_POTATOES = new ItemFood(5, 0.5f, false).setCreativeTab(BWCreativeTabs.BWTAB).setRegistryName("beef_potatoes");
    public static final Item CHICKEN_SOUP = new ItemSoup(5).setMaxStackSize(64).setCreativeTab(BWCreativeTabs.BWTAB).setRegistryName("chicken_soup");
    public static final Item CHOCOLATE = new ItemFood(2,0.2f, false).setCreativeTab(BWCreativeTabs.BWTAB).setRegistryName("chocolate");
    public static final Item CHOWDER = new ItemSoup(4).setMaxStackSize(64).setCreativeTab(BWCreativeTabs.BWTAB).setRegistryName("chowder");
    public static final Item COOKED_KEBAB = new ItemFood(4, 0.4f, false).setCreativeTab(BWCreativeTabs.BWTAB).setRegistryName("cooked_kebab");
    ...
    public static final Item RAW_KEBAB = new ItemFood(2, 0.3f,false).setPotionEffect(new PotionEffect(MobEffects.HUNGER, 600, 0), 0.3F).setCreativeTab(BWCreativeTabs.BWTAB).setRegistryName("raw_kebab");
    public static final Item PORK_DINNER = new ItemFood(6,0.6f, false).setCreativeTab(BWCreativeTabs.BWTAB).setRegistryName("pork_dinner");
